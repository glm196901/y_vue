...
<head>
    ...
    <title>百花争艳</title>
    <style media="screen">
        body {background-size: 100%;z-index:10;  height: 100%; width: 100%; position: absolute; background: #DEF2E9}
        * {margin: 0;padding: 0;font-family: 微软雅黑;}
        a {text-decoration: none;}
        input {outline: none}
        li {list-style: none;}
        p{font-size: 0.3rem;}
        .fr{float:right; color: #177C69}
        .fl{float:left; }
        ...
        .head{ width: 100%;height: 6rem;text-align: center;; z-index:20; background: url(http://play.zdzlw.com/img/v/vapp/activity/flower/flowerBack.png);background-repeat: no-repeat; background-size: 100%}
        .textinfo{text-align: left;padding: 0.2rem 0rem; color: #177C69;font-weight: 550;z-index: 5;}
        ...
        .detil .active{
            width: 3rem;
            height: 1.05rem;
            background:url(http://play.zdzlw.com/img/v/vapp/activity/flower/flowerBtn.png);
        ...
        .noactive{
            width: 3rem;
            height: 1.05rem;
            background:url(http://play.zdzlw.com/img/v/vapp/activity/flower/noactive.png);
            background-repeat: no-repeat;
            background-size: 100%;
            padding: 0;
            border: none;
        ...
        /* 刷新按钮颜色 */
        .el-icon-refresh:before{color:#177C69}
        ...
        .fontstyle{
            ...
            color:rgba(255,255,255,1);
            /* 本次活动字体不渐变 */
            /* background:linear-gradient(0deg,rgba(23,124,105) 0.537109375%, rgba(255,227,179,1) 100%); */
            background: #177C69;
        ...
        .el-table td, .el-table th.is-leaf{
            border-bottom:1px solid #DEF2E9;
        }
        .el-table--border::after, .el-table--group::after, .el-table::before{
            background-color: #DEF2E9
        }
        .el-table--border td, .el-table--border th, .el-table__body-wrapper .el-table--border.is-scrolling-left~.el-table__fixed{
            border-right: 1px solid #DEF2E9;
        }
        .el-table thead{
            /* 榜单头颜色 */
            color:#329883;
        ...
        tbody tr:nth-child(1)>td:nth-child(1) .cell {
            width: 0.2rem;
            height: 0.7rem;
            background: url(http://play.zdzlw.com/img/v/vapp/activity/flower/top.png);
            background-repeat: no-repeat;
            background-size: 100%;
            margin: 0 auto;
        }
        tbody tr:nth-child(2)>td:nth-child(1) .cell {
            width: 0.2rem;
            height: 0.7rem;
            background: url(http://play.zdzlw.com/img/v/vapp/activity/flower/second.png);
            background-repeat: no-repeat;
            background-size: 100%;
            margin: 0 auto;
        }
        tbody tr:nth-child(3)>td:nth-child(1) .cell {
            width: 0.2rem;
            height: 0.7rem;
            background: url(http://play.zdzlw.com/img/v/vapp/activity/flower/third.png);
            background-repeat: no-repeat;
            background-size: 100%;
            margin: 0 auto;
        }
        ...
        .jump1{
            background:url(http://play.zdzlw.com/img/v/vapp/activity/flower/congratulation.png);  height: 5rem ; background-size:100%; background-repeat: no-repeat;

        }
        .jump1 .el-icon-close{
            top: 1.5rem;right: 0.2rem
        }
        .jump2{
            background:url(http://play.zdzlw.com/img/v/vapp/activity/flower/kaijiang.png); background-size:100%; background-repeat: no-repeat;

        }
        .jump3{
            background:url(http://play.zdzlw.com/img/v/vapp/activity/flower/awkward.png);  height: 4rem; line-height: 2rem; background-size:100%; background-repeat: no-repeat;
        }

        /* 新增花瓣装饰 */
        /* .flowerLeftTop{ width: 1rem;  top: 9.5rem;right: 0;position: absolute;z-index: 10;}
        .flowerLeft{width: 1.5rem;top: 18.5rem;right: 0;position: absolute;z-index: 10;}
        .flowerRight{width: 1.2rem; top: 19rem;left: 0;position: absolute;z-index: 10;} */
    </style>
    <title></title>
    <script>
...
<div id="app" style="font-size: 0.3rem;" v-loading="loading">
    <!-- <el-tabs v-model="activeName" type="card">
      <el-tab-pane label="权力的游戏" name="first"> -->
    <div class="head">
        <!-- <img :src="imgsrc" alt=""> -->
    <!-- <button   @click="getData" class="refreshbtn fr btn">刷新</button> -->
    ...
    <!-- 删掉了花瓣装饰 -->
    <!-- <img class="flowerLeftTop" src="http://play.zdzlw.com/img/v/vapp/activity/flower/leftTopFlower.png" alt="">

    <img class="flowerLeft" src="http://play.zdzlw.com/img/v/vapp/activity/flower/leftFlower.png" alt="">

    <img class="flowerRight" src="http://play.zdzlw.com/img/v/vapp/activity/flower/rightFlower.png"> -->
    ...
    <div class="detil" v-show="showdetil">
        ...
        <div class="bottom">
            ...
            <p class="addd"><span></span><span class="fr">甘露</span><span class="fr" v-text="main_score"></span></p>
        </div>
        ...
        <div class="textinfo">
            <div  class="text item">
                ...
                <p style="text-align:center; letter-spacing: 0.1rem; color:#177C69" >2019年5.13 至 2019年5.19</p>
                <p class="init">
                    <img  class="left" :src="ImgLineLeft" alt="">
                ...
                <p>故事背景 ：</p>
                <br>
                <p>五月春季，百花争艳，春之母会从百花中挑选三甲进入花仙界，需要各位看官浇灌甘露助百花光彩绽放，荣登花仙界。</p>
                <br>
                <ul>
                    <li>1、春之母挑选三甲进入花仙界，需要看官浇灌甘露（1钻石=1甘露）</li>
                    <li>2、各位看官可以为自己心爱的主播灌溉甘露，助主播绽放花瓣</li>
                    <li>3、每绽放一瓣花瓣，春之母会在绽放花瓣的主播房间发放福利</li>
                </ul>
                <p class="init" style="padding-left:2.2rem">
                    <img  class="left" :src="ImgLineLeft" alt="">
                    <span class="titlep fontstyle">排行榜</span>
                    <img class="right" :src="ImgLineRight" alt="">
                </p>
                <ul>
                    <li>花瓣绽放数排行榜，每在直播间灌溉一万点甘露，该直播间主播花瓣绽放数+1</li>
                    <li>甘露灌溉值排行榜，看官灌溉甘露值合计由高到低的排名</li>
                </ul>
                <p class="init" style="padding-left:2.42rem">
                    <img  class="left" :src="ImgLineLeft" alt="">
                ...
                <ul>
                    <li>1、绽放花瓣的直播间由春之母发放福利，点击领取既有机会获得钻石奖励</li>
                    <li>2 特别奖  本周活动排行榜  榜壹并收取45万钻石，奖励该主播 定制专属粉丝团座驾</li>
                    <li>3、花瓣绽放排名前三，分别获得300元、150元、50元现金奖励</li>
                    <li>4、甘露灌溉排名前三，分别获得3000钻、1500钻、500钻奖励</li>
                    <li>5、活动奖励发放时间：5月20日</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="list text" v-show="showlist" >
        ...
        <p class="initlist" >
            <img class="left" :src="ImgLineLeft" alt="">
            <span class="fontstyle">花瓣数榜单</span>
            <img class="right" :src="ImgLineRight" alt="">
        </p>
        ...
        <el-table :data="leaderships"  border style="width: 100%">
            ...
            <el-table-column prop="counts" label="花瓣数" width="100"></el-table-column>
        </el-table>
        <p class="initlist">
            <img class="left" :src="ImgLineLeft" alt="">
            <span class="fontstyle">甘露值榜单</span>
            <img class="right" :src="ImgLineRight" alt="">
        </p>
        <el-table :data="brush_list"  border style="width: 100%">
            <el-table-column prop="classname"  label="排名" width="100"></el-table-column>
            <el-table-column prop="nickname" label="用户名称" ></el-table-column>
            <el-table-column prop="sum_points" label="甘露值排名" width="100"></el-table-column>
        </el-table>
    </div>
    ...
    var vm=new Vue({
        data() {
            return {
                ...
                toggle1:false,
                xxx:'el-icon-refresh',
                ImgLineLeft:'http://play.zdzlw.com/img/v/vapp/activity/flower/leftLine.png',
                ImgLineRight:'http://play.zdzlw.com/img/v/vapp/activity/flower/rightLine.png',
                dspRule:false,
                dspMain:true,
                MyCountNum:"",//进度条积分
                progressNum:0,
        ...
        methods: {
            ...
            getData(){//获取参数
                ...
                // url='http://zb-api-ceshi.mekxfj.com'
                ...
                this.network(url+'/api/activity/yearInfo?api_token='+api_token,null,res=>{
            ...
            act(){//扔鞭炮
                ...
                if(status==1){
                    ...
                    if(j<2){
                        ...
                        this.network(url+'/api/activity/yearUserThrow',data,res=>{
                            if(res.status==0){
                            let status=this.status
            ...
            getInfoList(){
                ...
                // url='http://zb-api-ceshi.mekxfj.com'
                let dark=this.dark
                this.network(url+'/api/activity/getBrushList?api_token='+api_token,null,res=>{
                    if(res.status==0){
                    this.loading=false
